...
#+setupfile: headers
#+OPTIONS: auto-id:t
#+HTML_HEAD_EXTRA: <meta name="description" content="Elyk's StumpWM config" />
#+HTML_HEAD_EXTRA: <meta property="og:title" content="Elyk's StumpWM config" />
#+HTML_HEAD_EXTRA: <meta property="og:description" content="Description of the Stump Window Manager configuration files of Elyk" />
...
I’ll prefix the variables’ name with ~elyk-~ just in case it might
...
(mapconcat (lambda (color)
             (format "(defvar elyk-%s \"%s\")" (car color) (cadr color)))
           colors
           "\n")
#+end_src
...
#+begin_src lisp
(defvar elyk-nord0 "#2e3440")
(defvar elyk-nord1 "#3b4252")
(defvar elyk-nord2 "#434c5e")
(defvar elyk-nord3 "#4c566a")
(defvar elyk-nord4 "#d8dee9")
(defvar elyk-nord5 "#e5e9f0")
(defvar elyk-nord6 "#eceff4")
(defvar elyk-nord7 "#8fbcbb")
(defvar elyk-nord8 "#88c0d0")
(defvar elyk-nord9 "#81a1c1")
(defvar elyk-nord10 "#5e81ac")
(defvar elyk-nord11 "#bf616a")
(defvar elyk-nord12 "#d08770")
(defvar elyk-nord13 "#ebcb8b")
(defvar elyk-nord14 "#a3be8c")
(defvar elyk-nord15 "#b48ead")
#+end_src
...
(setq *colors*
      `(,elyk-nord1   ;; 0 black
        ,elyk-nord11  ;; 1 red
        ,elyk-nord14  ;; 2 green
        ,elyk-nord13  ;; 3 yellow
        ,elyk-nord10  ;; 4 blue
        ,elyk-nord14  ;; 5 magenta
        ,elyk-nord8   ;; 6 cyan
        ,elyk-nord5)) ;; 7 white
...
#+begin_src lisp
(setf *mode-line-background-color* elyk-nord1
      ,*mode-line-foreground-color* elyk-nord5)
#+end_src

We /could/ also use some borders in the modeline. But we won’t. Let’s
still set its color to Nord1, just in case.
#+begin_src lisp
(setf *mode-line-border-color* elyk-nord1
  ...
  (when elements
    (cons (format nil
                  ...
                  (format nil "^(:fg \"~A\")^(:bg \"~A\")^f1~A^f0"
                          (if (xor not-invertedp rightp) elyk-nord1 elyk-nord3)
                          (if (xor not-invertedp rightp) elyk-nord3 elyk-nord1)
                          (if rightp "" ""))
                  (if not-invertedp elyk-nord3 elyk-nord1))
...
#+begin_src lisp
(set-border-color        elyk-nord1)
(set-focus-color         elyk-nord1)
(set-unfocus-color       elyk-nord3)
(set-float-focus-color   elyk-nord1)
(set-float-unfocus-color elyk-nord3)
#+end_src

Let’s also set the colors of the message and input windows:
#+begin_src lisp
(set-fg-color elyk-nord4)
(set-bg-color elyk-nord1)
#+end_src
...
I also have a [[https://github.com/Elyk/stumpwm/tree/feature/no-hardcoded-which-key-format][StumpWM fork]] that introduces two new variables for
