...
#+AUTHOR: Elyk Es (EE)
#+DESCRIPTION: Modified version of DT's Doom Emacs Config
...
following me on YouTube look at my configs as "documentation".
...
Firefox.  I don't actually use tabs in Emacs.  I placed this in my config to
help others who may want tabs.  In the default configuration of Doom Emacs, 'SPC
t' is used for "toggle" keybindings, so I choose 'SPC t c' to toggle
centaur-tabs.  The "g" prefix for keybindings is used for a bunch of evil
keybindings in Doom, but "g" plus the arrow keys were not used, so I thought I
would bind those for tab navigation.  But I did leave the default "g t" and "g
T" intact if you prefer to use those for centaur-tabs-forward/backward.
...
|-----------------------+---------------------------+-----------------------|
| ee/insert-todays-date | Friday, 19 November, 2021 | SPC i d t             |
| ee/insert-todays-date | 19-11-2021                | SPC u SPC i d t       |
| ee/insert-todays-date | 2021-11-19                | SPC u SPC u SPC i d t |
| ee/insert-any-date    | Friday, November 19, 2021 | SPC i d a             |
...
This is to replace some of the default settings to saner and faster defaults.
