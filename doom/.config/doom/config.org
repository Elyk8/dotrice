#+deproperty: header-args :elisp :exports code
...
- [[#i3-and-emacs][i3 and Emacs]]
  ...
  - [[#integration-bspwm][Integration bspwm]]
- [[#exwm][EXWM]]
...
#+begin_src emacs-lisp :tangle "modules/wmintegration/bspwm/packages.el"
;; -*- no-byte-compile: t; -*-
;;; wmintegration/bspwm/packages.el
#+end_src

#+begin_src emacs-lisp :tangle "modules/wmintegration/bspwm/config.el"
